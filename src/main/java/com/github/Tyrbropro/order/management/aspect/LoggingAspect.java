package com.github.Tyrbropro.order.management.aspect;
...
public final class LoggingAspect {
    ...
    @Around("execution( * com.github.Tyrbropro.order.management.controller..*(..))")
    ...
    @Around("execution(* com.github.Tyrbropro.order.management.service..*(..))")
